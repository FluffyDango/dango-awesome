...
```
yay -S awesome rofi picom i3lock-fancy xclip ttf-roboto polkit-gnome materia-theme lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager qt5-styleplugins papirus-icon-theme feh -y
```
...
Arch-Based Installs
```
git clone https://github.com/FluffyDango/dango-awesome ~/.config/awesome
```

Debian-Based Installs
```
git clone --branch debian https://github.com/FluffyDango/dango-awesome ~/.config/awesome
```
